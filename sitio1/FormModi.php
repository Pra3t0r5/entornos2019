        ...
        <FORM action="Modi.php" method="POST" name="FormModi">
            <table width="356">
                ...
                <tr>
                    ...
                    <td width="243"> <input type="TEXT" name="ClaveUsuario" size="20" maxlength="20" value="<?php echo ($fila['legajo']); ?>">
                    </td>
                </tr>
                <tr>
                    <td width="103"> D.N.I.: </td>
                    <td width="243"> <input type="TEXT" name="DNI" size="20" maxlength="20" value="<?php echo ($fila['dni']); ?>">
                    </td>
                </tr>
                <tr>
                    <td width="103"> eMail: </td>
                    <td width="243"> <input type="TEXT" name="eMail" size="20" maxlength="40" value="<?php echo ($fila['email']); ?>">
                    </td>
                </tr>
                <tr>
